...
class CoursesRcAdapter(val mainActivity: MainActivity): RecyclerView.Adapter<CoursesRcAdapter.CourseHolder>() {
    ...
    class CourseHolder(val binding: CourseListItemBinding,val mainActivity: MainActivity) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun setData(course: Course) = with(binding) {
         ...
         //   tvLikeCounter.text = course.likeCounter
            ...
            showPanels(isOwner(course))
                ...
                Log.d("MyLog", course.ratingCounter)
                Log.d("MyLog", course.ratingCounterPeople.toString())
                tvRaitingCount.text = (course.ratingCounter.toDouble() / course.ratingCounterPeople).toString()
